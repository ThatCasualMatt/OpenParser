<div style="clear:both;"></div>
	<hr />
	<footer>
        <div style="float:left"><p>&copy; <a href="https://github.com/ThatCasualMatt/OpenParser" target="_blank">ThatCasualMatt</a> <?php echo date('Y'); ?> | <a href="pp.php">Privacy Policy</a></p></div>
</div>
    </footer>
